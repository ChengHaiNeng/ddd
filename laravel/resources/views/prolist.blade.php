...
<style>
	...
	.fr{float: right;}
	.niwdoawi_center{height: 90px;width: 100%; background: #f8f8f7;}
	.daohang{line-height: 80px;width:80%;margin: 0px auto;}

	.main-header{width:80%;margin: 0px auto;height: 47px;}
	.main-h{line-height: 47px;font-size: 14px;}

	.main-center{width: 80%;margin: 0px auto;}
	.main-left{background: white;}
	.main-left ul li{line-height: 15px;}

	.acountcenter{line-height: 44px;}
	.zw{margin-left:50%;}
	.tab_content{background: white;}
...
<div class="row main-header">
	<div class="col-xs-12 main-h">	
	<a href="#" class="first">账户中心</a><span>></span><a href="" class="two">借款管理</a><span>></span><a href="#" class="three">项目审核</a>
	</div>
</div>
<div class="row main-center">
	<div class="col-xs-2 main-left">
		<span class="h3"><a href="#"><h3><small>账户中心</small></h3></a></span>
		<span class="h4"><a href="#"><h4><small>资金管理<select name="" id=""></select></small></h4></a></span>
		<ul class="nav zj">
			<li><a href="#">我要充值</a></li>
			<li><a href="#">我要提现</a></li>
			<li><a href="#">资金记录</a></li>
		...
		<span class="h4"><a href="#"><h4><small>投资管理<select name="" id=""></select></small></h4></a></span>
		<ul class="nav tz">
			<li><a href="#">嘉财有道</a></li>
			<li><a href="#">嘉猜宝</a></li>
			<li><a href="#">我的债权</a></li>
		...
		<span class="h4"><a href="#"><h4><small>借款管理<select name="" id=""></select></small></h4></a></span>
		<ul class="nav jk">
			<li><a href="#">我要还款</a></li>
			<li><a href="#">借款记录</a></li>
			<li><a href="#">借款申请</a></li>
		</ul>
		<span class="h4"><a href="#"><h4><small>账户管理<select name="" id=""></select></small></h4></a></span>		
		<ul class="nav zh">
			<li><a href="#">个人资料</a></li>
			<li><a href="#">我的积分</a></li>
			<li><a href="#">安全中心</a></li>
		...
		<span class="h4"><a href="#"><h4><small>活动管理<select name="" id=""></select></small></h4></a></span>	
		<ul class="nav hd">
			<li><a href="#">我的礼品</a></li>
			<li><a href="#">推荐有奖</a></li>
			<li><a href="#">我要推荐</a></li>
	...
	<div class="col-xs-10 main-right">
		<div class="row acountcenter">
			<span><h4>项目审核</h4></span>
		</div>
		<div class="row module">
			<form action="" class="nwd-formUi">
				<ul class="nav nav-tabs nav-justified zt">
					<li><span>状态:</span></li>
					<li><a href="#">全部</a></li>
					<li><a href="#">发布待审核</a></li>
					<li><a href="#">未发布</a></li>
					<li><a href="#">招标中</a></li>
					<li><a href="#">满标待审核</a></li>
					<li><a href="#">借款成功</a></li>
					<li><a href="#">流标</a></li>
					<li><a href="#">更多</a></li>
				</ul>
			...
			<div class="tb-content">
                <table class="table">
                    ...
                    <tr>
                       ...
                       <td class="l"><a href="{{url('check',[$p->pid])}}">去审核</a></td>
                    </tr>
                    @empty
                    <div class="zw"><span class="zu">暂无记录</span></div>
                    @endforelse
                    </tbody>
                 </table>
			...
			<div class="row">
	        	...
	        	<ul class="clearfix fNav">
	                ...
	                <li>
	                    ...
	                    <a href="#" target="_blank" class="a01">联系我们</a><br>
	                    <a href="#" target="_blank" class="a01">网站地图</a><br>
	                    <a href="#" target="_blank" class="a01">服务地区</a><br>
	                </li>	
	            </ul>
	        </div>
	        <div class="col-xs-4">
