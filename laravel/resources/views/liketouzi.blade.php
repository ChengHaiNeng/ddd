...
<head>
	...
	.main{width: 80%;margin: 0px auto; margin-top: 20px;}
	.main{height: 130px;}
	.p1{font-size: 14px;color: rgb(87, 178, 8);}
	.main-left{background: white;}
	.main ul li{float: left; width: 127px;padding: 0px 20px;}
	.fc_9{font-size:14px;color:rgb(153, 153, 153);line-height: 24px;}
	.main-right{background: #fff9ea;}
	.bt1{margin-left: 170px;margin-top: 92px;}
...
<body class="container holiday_bg ">
		...
		<div class="row main">
			<div class="row">
				<div class="col-xs-8 main-left">
					<h3 class="p1">
						<span class="g_p1">账户资金安全由银行委托管理</span>
					</h3>
					<ul class="nav navbar td_all">
							<li class="fl td1">
	                        ...
	                        <li class="fl td5">
	                            ...
	                            <p><span class="airal fs_24 fc_orange">
	                                   {{sprintf('%.2f',($pro->money-$pro->recive)/100)}}
	                            </span>元</p>
	                        </li>
					</ul>
				</div>
				<div class="col-xs-4 main-right">
					...
					<form class="form-inline" role="form" method="post" action ="{{url('/pay')}}">
					{!!csrf_field()!!}
					  <div class="form-group">
					  	<span class="jin">投注金额:</span>
					    <label class="sr-only" for="name">金额</label>
					    <input type="text" class="form-control" id="money" name="money" placeholder="请输入金额" value = "{{sprintf('%.2f',($pro->money-$pro->recive)/100)}}">元
					  </div>
					  <input type="hidden" name="pid" value="{{$pro->pid}}" placeholder="">
					  <div class="bt1">					  	
					  <button type="submit" class="btn btn-default">确认购买</button>
					  </div>
					</form>
